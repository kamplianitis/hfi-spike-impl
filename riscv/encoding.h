...
#define HFI_ENABLED_MASK      0x0000000000000001ULL // Bit 0
#define HFI_EXIT_REASON_MASK  0x0000000000000006ULL // Bits 1–2
#define HFI_EXIT_PC_MASK      0x7FFFFFFFFFFFFFF8ULL // Bits 3–62
#define HFI_EXIT_REASON_SHIFT 1                    // Shift for exit reason
#define HFI_EXIT_PC_SHIFT     3                    // Shift for exit PC
#define HFI_OPTION_REDIRECT_EXIT_MASK 0b0010       // Bit 1
#define HFI_OPTION_REDIRECT_ECAL_MASK 0b0100       // Bit 2
...
#define MATCH_HVER 0x400b
#define MASK_HVER 0xfe00707f
#define MATCH_HENTER 0xb
#define MASK_HENTER 0xfe00707f
#define MATCH_HEXIT 0x200000b
#define MASK_HEXIT 0xfe00707f 
#define MATCH_HSTBS 0x200200b
#define MASK_HSTBS 0xfe00707f
#define MATCH_HSTBD 0xa00200b
#define MASK_HSTBD 0xfe00707f
#define MATCH_HSTPRM 0x600200b
#define MASK_HSTPRM 0xfe00707f
#define MATCH_HSTCONFIGREGION 0x200b
#define MASK_HSTCONFIGREGION 0xfe00707f
#define MATCH_HGTBS 0x400200b
#define MASK_HGTBS 0xfe00707f
#define MATCH_HGTBD 0xc00200b
#define MASK_HGTBD 0xfe00707f
#define MATCH_HGTPRM 0x800200b
#define MASK_HGTPRM 0xfe00707f
#define MATCH_HSTXHDLR 0x100b
#define MASK_HSTXHDLR 0xfe00707f
#define MATCH_HGTXHDLR 0x200100b
#define MASK_HGTXHDLR 0xfe00707f
#define MATCH_HLB 0x6b
#define MASK_HLB 0x707f
#define MATCH_HLBU 0x406b
#define MASK_HLBU 0x707f
#define MATCH_HLH 0x106b
#define MASK_HLH 0x707f
#define MATCH_HLHU 0x506b
#define MASK_HLHU 0x707f
#define MATCH_HLW 0x206b
#define MASK_HLW 0x707f
#define MATCH_HLWU 0x606b
#define MASK_HLWU 0x707f
#define MATCH_HLD 0x306b
#define MASK_HLD 0x707f
#define MATCH_HSB 0x2b
#define MASK_HSB 0x707f
#define MATCH_HSH 0x102b
#define MASK_HSH 0x707f
#define MATCH_HSD 0x302b
#define MASK_HSD 0x707f
#define MATCH_HSW 0x202b
#define MASK_HSW 0x707f
#define MATCH_HENTERTARG 0x20000b
#define MASK_HENTERTARG 0xfe00707f
...
#define CSR_HFISTATUS 0xbc0
#define CSR_HFIPERMISSIONS 0xbc1
#define CSR_HFIIMPLICITBASE1 0xbc2
#define CSR_HFIIMPLICITMASK1 0xbc3
#define CSR_HFIEXPLICITBASE1 0xbc4
#define CSR_HFIEXPLICITBOUND1 0xbc5
#define CSR_HFICURRENTREGION 0xbc6
#define CSR_HFICODEBASE 0xbc7
#define CSR_HFICODEMASK 0xbc8
#define CSR_HFIOPTIONS 0xbc9
#define CSR_HFI_EXITHANDLER 0xbca
#define CSR_HFICAUSE 0xbcb
...
DECLARE_INSN(hver, MATCH_HVER, MASK_HVER)
DECLARE_INSN(henter, MATCH_HENTER, MASK_HENTER)
DECLARE_INSN(hentertarg, MATCH_HENTERTARG, MASK_HENTERTARG)
DECLARE_INSN(hexit, MATCH_HEXIT, MASK_HEXIT)
DECLARE_INSN(hstbs, MATCH_HSTBS, MASK_HSTBS)
DECLARE_INSN(hstbd, MATCH_HSTBD, MASK_HSTBD)
DECLARE_INSN(hstprm, MATCH_HSTPRM, MASK_HSTPRM)
DECLARE_INSN(hstconfigregion, MATCH_HSTCONFIGREGION, MASK_HSTCONFIGREGION)
DECLARE_INSN(hlb, MATCH_HLB, MASK_HLB)
DECLARE_INSN(hlbu, MATCH_HLBU, MASK_HLBU)
DECLARE_INSN(hlh, MATCH_HLH, MASK_HLH)
DECLARE_INSN(hlhu, MATCH_HLHU, MASK_HLHU)
DECLARE_INSN(hlw, MATCH_HLW, MASK_HLW)
DECLARE_INSN(hlwu, MATCH_HLWU, MASK_HLWU)
DECLARE_INSN(hld, MATCH_HLD, MASK_HLD)
DECLARE_INSN(hsb, MATCH_HSB, MASK_HSB)
DECLARE_INSN(hsh, MATCH_HSH, MASK_HSH)
DECLARE_INSN(hsw, MATCH_HSW, MASK_HSW)
DECLARE_INSN(hsd, MATCH_HSD, MASK_HSD)
DECLARE_INSN(hstxhdlr, MATCH_HSTXHDLR, MASK_HSTXHDLR)
DECLARE_INSN(hgtxhdlr, MATCH_HGTXHDLR, MASK_HGTXHDLR)
DECLARE_INSN(hgtbs, MATCH_HGTBS, MASK_HGTBS)
DECLARE_INSN(hgtbd, MATCH_HGTBD, MASK_HGTBD)
DECLARE_INSN(hgtprm, MATCH_HGTPRM, MASK_HGTPRM)
